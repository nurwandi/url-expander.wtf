  ...
  return (
    <div className="w-full max-w-5xl mx-auto">
      <div className="flex flex-col mb-12 md:mb-16">
        <h2 className="text-display-m md:text-display-l font-medium mb-4 text-center tracking-tight text-gray-900 dark:text-anthropic-cream transition-colors duration-200">
          Frequently Asked <span className="text-anthropic-rust transition-colors duration-200">Why</span> Questions
        </h2>
      </div>
      ...
      <div className="flex flex-col lg:flex-row gap-12">
          ...
          <Accordion type="single" collapsible className="w-full">
            {faqItems.map((item, index) => (
              <AccordionItem
                key={index}
                value={`item-${index}`}
                className="border-b border-gray-200 dark:border-anthropic-cream-subtle last:border-b-0 transition-colors duration-200"
              >
                <AccordionTrigger className="py-5 hover:no-underline transition-colors duration-200">
                  <h3 className="text-lg md:text-xl font-medium text-gray-900 dark:text-anthropic-cream mb-0 text-left transition-colors duration-200">
                    {item.question}
                  </h3>
                </AccordionTrigger>
                <AccordionContent className="pb-5">
                  <div className="bg-gray-50 dark:bg-anthropic-slate-medium p-6 border border-gray-200 dark:border-anthropic-cream-subtle mt-2 transition-colors duration-200">
                    <p className="text-gray-600 dark:text-anthropic-cream-muted text-base transition-colors duration-200">{item.answer}</p>
                  </div>
                </AccordionContent>
              </AccordionItem>
            ))}
        ...
        <div className="hidden lg:block lg:w-1/2">
          <div className="bg-gray-50 dark:bg-anthropic-slate-light p-10 border border-gray-200 dark:border-anthropic-cream-subtle h-full flex items-center justify-center transition-colors duration-200">
            <div className="text-center space-y-6">
              <div className="mb-4">
                <svg
                  ...
                  className="mx-auto text-anthropic-rust transition-colors duration-200"
                >
              ...
              <h3 className="text-2xl font-medium text-gray-900 dark:text-anthropic-cream mb-3 transition-colors duration-200">
                Got More Questions?
              </h3>
              <p className="text-gray-600 dark:text-anthropic-cream-muted text-base transition-colors duration-200">
