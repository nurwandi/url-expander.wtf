  ...
  return (
    <div className="w-full max-w-7xl mx-auto relative">
      ...
      <div className="mb-12 md:mb-16 relative z-10">
        {/* Large heading with underline style like Anthropic */}
        <h1 className="text-4xl md:text-6xl lg:text-7xl font-bold font-display mb-6 md:mb-8 leading-tight max-w-5xl">
          ...
          <br />
          <span className="inline-block underline decoration-4 decoration-anthropic-rust underline-offset-4">Ridiculously</span>{' '}
          <span className="inline-block">Pointless</span>
        </h1>

        {/* Subtitle - Anthropic style */}
        <div className="max-w-3xl">
          <p className="text-lg md:text-2xl text-anthropic-text leading-relaxed font-normal">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mt-12">
        ...
        <div className="bg-white/40 backdrop-blur-md rounded-3xl p-8 transition-all duration-300 group cursor-pointer border border-white/60 shadow-lg hover:bg-white/50">
          <div className="mb-6">
            <svg className="w-16 h-16 text-anthropic-rust" viewBox="0 0 64 64" fill="none" xmlns="http://www.w3.org/2000/svg">
          ...
          <h3 className="text-xl font-bold font-display mb-3 text-anthropic-text group-hover:text-anthropic-rust transition-colors">
            Completely Unnecessary
          </h3>
          <p className="text-sm text-anthropic-text-muted leading-relaxed">
